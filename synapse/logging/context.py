...
class LoggingContext:
    ...
    @tracer.start_as_current_span("LoggingContext - init")
    def __init__(
        self,
    ...
    @classmethod
    @tracer.start_as_current_span("LoggingContext - current_context")
    ...
    @classmethod
    @tracer.start_as_current_span("LoggingContext - set_current_context")
    ...
    @tracer.start_as_current_span("LoggingContext - __enter__")
    ...
    @tracer.start_as_current_span("LoggingContext - __exit__")
    def __exit__(
        self,
    ...
    @tracer.start_as_current_span("LoggingContext - start")
    def start(self, rusage: "Optional[resource.struct_rusage]") -> None:
        """
    ...
    @tracer.start_as_current_span("LoggingContext - stop")
    def stop(self, rusage: "Optional[resource.struct_rusage]") -> None:
        """
    ...
    @tracer.start_as_current_span("LoggingContext - get_resource_usage")
    ...
    @tracer.start_as_current_span("LoggingContext - _get_cputime")
    ...
    @tracer.start_as_current_span("LoggingContext - add_cputime")
    ...
    @tracer.start_as_current_span("LoggingContext - add_database_transaction")
    def add_database_transaction(self, duration_sec: float) -> None:
    ...
    @tracer.start_as_current_span("LoggingContext - add_database_scheduled")
    def add_database_scheduled(self, sched_sec: float) -> None:
    ...
    @tracer.start_as_current_span("LoggingContext - record_event_fetch")
    def record_event_fetch(self, event_count: int) -> None:
...
@tracer.start_as_current_span("LoggingContextFilter")
class LoggingContextFilter(logging.Filter):
    ...
    @tracer.start_as_current_span("LoggingContextFilter - filter")
...
@tracer.start_as_current_span("PreserveLoggingContext")
...
@tracer.start_as_current_span("current_context")
def current_context() -> LoggingContextOrSentinel:
    """Get the current logging context from thread local storage"""
    return getattr(_thread_local, "current_context", SENTINEL_CONTEXT)

@tracer.start_as_current_span("set_current_context")
...
@tracer.start_as_current_span("nested_logging_context")
...
@tracer.start_as_current_span("_unwrap_awaitable")
...
@overload
@tracer.start_as_current_span("preserve_fn")
def preserve_fn(
...
@overload
@tracer.start_as_current_span("run_in_background")
...
@tracer.start_as_current_span("run_coroutine_in_background")
...
@tracer.start_as_current_span("make_deferred_yieldable")
...
@tracer.start_as_current_span("defer_to_threadpool")
