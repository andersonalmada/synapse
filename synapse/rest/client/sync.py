...
class SyncRestServlet(RestServlet):
    ...
    def __init__(self, hs: "HomeServer"):
        with tracer.start_as_current_span("sync.syncrestservlet.__init__") as child:
            child.set_attribute("handler_type", "sync")
            super().__init__()
            self.hs = hs
    ...
    @tracer.start_as_current_span("sync-get")
    async def on_GET(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        with tracer.start_as_current_span("sync.syncrestservlet.onget") as child:
            child.set_attribute("handler_type", "sync")
            ...
            with tracer.start_as_current_span("sync-auth-request") as child:
            ...
            with tracer.start_as_current_span("sync-filter") as child:
            ...
            with tracer.start_as_current_span("sync-since") as child:
            ...
            with tracer.start_as_current_span("sync-ratelimit") as child:
            ...
            with tracer.start_as_current_span("sync-presence_handler") as child:
            ...
            with tracer.start_as_current_span("sync-sync_handler") as child:            
                with context:
            ...
            with tracer.start_as_current_span("sync-disconnected") as child:
            ...
            with tracer.start_as_current_span("sync-encode_response") as child:
    ...
    @tracer.start_as_current_span("sync.encode_response")
    async def encode_response(
        ...
        with tracer.start_as_current_span("sync.syncrestservlet.encode_response") as child:
            child.set_attribute("handler_type", "sync")
    ...
    @staticmethod
    @tracer.start_as_current_span("sync.encode_presence")
    def encode_presence(events: List[UserPresenceState], time_now: int) -> JsonDict:
        with tracer.start_as_current_span("sync.syncrestservlet.encode_presence") as child:
            child.set_attribute("handler_type", "sync")
            return {
                "events": [
                    {
    ...
    @tracer.start_as_current_span("sync.encode_joined")
    async def encode_joined(
        ...
        with tracer.start_as_current_span("sync.syncrestservlet.encode_joined") as child:
            child.set_attribute("handler_type", "sync")
            """
    ...
    @tracer.start_as_current_span("sync.encode_invited")
    async def encode_invited(
        ...
        serialize_options: SerializeEventConfig,
         ...
         with tracer.start_as_current_span("sync.syncrestservlet.encode_invited") as child:
            child.set_attribute("handler_type", "sync")
            """
    ...
    @tracer.start_as_current_span("sync.encode_knocked")
    async def encode_knocked(
        ...
        with tracer.start_as_current_span("sync.syncrestservlet.encode_knocked") as child:
            child.set_attribute("handler_type", "sync")
            """
    ...
    @tracer.start_as_current_span("sync.encode_archived")
    async def encode_archived(
        ...
        with tracer.start_as_current_span("sync.syncrestservlet.encode_archived") as child:
            child.set_attribute("handler_type", "sync")
            """
    ...
    @tracer.start_as_current_span("sync.encode_room")
    async def encode_room(
        ...
        with tracer.start_as_current_span("sync.syncrestservlet.encode_room") as child:
            child.set_attribute("handler_type", "sync")
            """
            Args:
                sync_config
...
class SlidingSyncE2eeRestServlet(RestServlet):
    ...
    def __init__(self, hs: "HomeServer"):
        with tracer.start_as_current_span("sync.slidingsynce2eerestservlet.__init__") as child:
            child.set_attribute("handler_type", "sync")
            super().__init__()
            self.hs = hs
            self.auth = hs.get_auth()
    ...
    async def on_GET(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        with tracer.start_as_current_span("sync.slidingsynce2eerestservlet.onget") as child:
            child.set_attribute("handler_type", "sync")
...
class SlidingSyncRestServlet(RestServlet):
    ...
    def __init__(self, hs: "HomeServer"):
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.__init__") as child:
            child.set_attribute("handler_type", "sync")
            super().__init__()
            self.auth = hs.get_auth()
            self.store = hs.get_datastores().main
    ...
    async def on_POST(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.onpost") as child:
            child.set_attribute("handler_type", "sync")
            requester = await self.auth.get_user_by_req_experimental_feature(
                request, allow_guest=True, feature=ExperimentalFeature.MSC3575
            )
    ...
    async def encode_response(
        ...
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.encode_response") as child:
            child.set_attribute("handler_type", "sync")
            response: JsonDict = defaultdict(dict)
    ...
    def encode_lists(
        ...
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.encode_lists") as child:
            child.set_attribute("handler_type", "sync")
    ...
    async def encode_rooms(
        ...
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.encode_rooms") as child:
            child.set_attribute("handler_type", "sync")
            time_now = self.clock.time_msec()
    ...
    async def encode_extensions(
        ...
        with tracer.start_as_current_span("sync.slidingsyncrestservlet.encode_extensions") as child:
            child.set_attribute("handler_type", "sync")
