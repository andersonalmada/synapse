...
class SyncHandler:
    ...
    with tracer.start_as_current_span("sync-wait_for_sync_for_user") as parent:
        async def wait_for_sync_for_user(
            self,
            requester: Requester,
            sync_config: SyncConfig,
            ...
            with tracer.start_as_current_span("sync-auth_blocking") as child:
                user_id = sync_config.user.to_string()
                await self.auth_blocking.check_auth_blocking(requester=requester)

            with tracer.start_as_current_span("sync-response_cache") as child:            
    ...
    async def _wait_for_sync_for_user(
        ...
        """
        with tracer.start_as_current_span("sync-since_token") as child:            
        ...
        with tracer.start_as_current_span("sync-not_since_token") as child:            
            if since_token is not None:
        ...
        with tracer.start_as_current_span("sync-timeout_not_since_token") as child:            
            if timeout == 0 or since_token is None or full_state:
                # we are going to return immediately, so don't bother calling
                # notifier.wait_for_events.
                with tracer.start_as_current_span("sync-current_sync_for_user_2") as child:            
                    result: Union[
                ...
                with tracer.start_as_current_span("sync-current_sync_for_user_3") as child:            
                ...
                with tracer.start_as_current_span("sync-wait_for_events") as child:            
        ...
        with tracer.start_as_current_span("sync-next_batch") as child:            
    ...
    async def current_sync_for_user(
        ...
        Returns:
            ...
            When `SyncVersion.E2EE_SYNC`, returns a `E2eeSyncResult`.
        """
        with tracer.start_as_current_span("sync-current_sync_for_user") as child:            
