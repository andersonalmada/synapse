...
class StreamToken:
    ...
    @classmethod
    @cancellable
    @tracer.start_as_current_span("StreamToken - from_string")
    ...
    @tracer.start_as_current_span("StreamToken - to_string")
    async def to_string(self, store: "DataStore") -> str:
    ...
    @tracer.start_as_current_span("StreamToken - copy_and_advance")
